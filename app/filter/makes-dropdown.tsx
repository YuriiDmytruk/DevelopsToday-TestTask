...
const MakesDropdown: FC<MakesDropdownProps> = ({
    vehicleMakes,
    vehicleMake,
    setVehicleMake,
}) => {
    ...
    return (
        <DropdownMenu
            onOpenChange={() => setIsSelectorOpen((prevState) => !prevState)}
        >
            <DropdownMenuTrigger>
                <Badge
                    variant="outline"
                ...
                >
                    ...
                    {isSelectorOpen ? <ChevronUp /> : <ChevronDown />}
                </Badge>
            </DropdownMenuTrigger>
            <DropdownMenuContent>
                <Command>
                    ...
                    <CommandList>
                        {vehicleMakes
                            .slice(0, MAX_VEHICLE_MAKES_SHOWN)
